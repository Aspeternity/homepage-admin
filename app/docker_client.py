...
SERVICE_PROFILES: list[dict[str, Any]] = [
    {"needles": ("jellyfin",), "icon": "sh-jellyfin", "widget": "jellyfin", "description": "影视媒体中心", "kind": "影音媒体", "confidence": "高", "group_hints": ("NAS", "媒体", "Media")},
    {"needles": ("qbittorrent",), "icon": "sh-qbittorrent", "widget": "qbittorrent", "description": "qBittorrent 下载器", "kind": "下载工具", "confidence": "高", "group_hints": ("NAS", "下载", "Downloads")},
    {"needles": ("transmission",), "icon": "sh-transmission", "widget": "transmission", "description": "Transmission 下载器", "kind": "下载工具", "confidence": "高", "group_hints": ("NAS", "下载", "Downloads")},
    {"needles": ("home-assistant", "homeassistant"), "icon": "sh-home-assistant", "widget": "homeassistant", "description": "Home Assistant 智能家居", "kind": "智能家居", "confidence": "高", "group_hints": ("Tools", "智能家居", "Home")},
    {"needles": ("portainer",), "icon": "sh-portainer", "widget": "portainer", "description": "Docker 容器管理", "kind": "容器管理", "confidence": "高", "group_hints": ("Tools", "管理")},
    {"needles": ("proxmox",), "icon": "sh-proxmox", "widget": "proxmox", "description": "Proxmox 虚拟化管理", "kind": "虚拟化管理", "confidence": "高", "group_hints": ("Tools", "管理")},
    {"needles": ("vaultwarden",), "icon": "sh-vaultwarden", "widget": "", "description": "Vaultwarden 密码管理", "kind": "密码管理", "confidence": "高", "group_hints": ("NAS", "Tools", "安全")},
    {"needles": ("nginx-proxy-manager",), "icon": "sh-nginxproxymanager", "widget": "", "description": "Nginx Proxy Manager 反向代理", "kind": "反向代理", "confidence": "高", "group_hints": ("Tools", "网络")},
    {"needles": ("moviepilot",), "icon": "mdi-movie-open", "widget": "", "description": "MoviePilot 影视自动化", "kind": "影音自动化", "confidence": "高", "group_hints": ("NAS", "媒体", "Media")},
    {"needles": ("metube",), "icon": "sh-metube", "widget": "", "description": "MeTube 视频下载", "kind": "下载工具", "confidence": "高", "group_hints": ("NAS", "下载", "Downloads")},
    {"needles": ("lsky",), "icon": "mdi-image-multiple", "widget": "", "description": "Lsky Pro 图床管理", "kind": "图床服务", "confidence": "高", "group_hints": ("NAS", "Tools", "图床")},
    {"needles": ("mkdocs",), "icon": "sh-mkdocs", "widget": "", "description": "MkDocs 文档站点", "kind": "文档站点", "confidence": "高", "group_hints": ("NAS", "Tools", "文档")},
    {"needles": ("phpmyadmin",), "icon": "sh-phpmyadmin", "widget": "", "description": "phpMyAdmin 数据库管理", "kind": "数据库管理", "confidence": "高", "group_hints": ("Tools", "NAS", "数据库")},
    {"needles": ("mysql",), "icon": "sh-mysql", "widget": "", "description": "MySQL 数据库", "kind": "数据库", "confidence": "高", "group_hints": ("Tools", "NAS", "数据库")},
    {"needles": ("komari",), "icon": "mdi-server-network", "widget": "", "description": "Komari 服务器监控", "kind": "服务器监控", "confidence": "高", "group_hints": ("Tools", "监控", "Monitoring")},
    {"needles": ("cookiecloud",), "icon": "", "widget": "", "description": "CookieCloud Cookie 同步", "kind": "同步工具", "confidence": "高", "group_hints": ("Tools", "同步")},
    {"needles": ("rustdesk",), "icon": "sh-rustdesk", "widget": "", "description": "RustDesk 远程桌面", "kind": "远程桌面", "confidence": "高", "group_hints": ("Tools", "远程")},
    {"needles": ("1panel",), "icon": "sh-1panel", "widget": "", "description": "1Panel 服务器运维面板", "kind": "服务器面板", "confidence": "高", "group_hints": ("Tools", "管理")},
    {"needles": ("gethomepage/homepage", " homepage "), "icon": "sh-homepage", "widget": "", "description": "Homepage 导航面板", "kind": "导航面板", "confidence": "高", "group_hints": ("Tools", "导航")},
]
