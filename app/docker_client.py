...
SERVICE_PROFILES: list[dict[str, Any]] = [
    ...
    {"needles": ("moviepilot",), "icon": "sh-moviepilot", "widget": "", "description": "MoviePilot 影视自动化", "kind": "影音自动化", "confidence": "高", "group_hints": ("群晖NAS", "媒体", "Media")},
    {"needles": ("metube",), "icon": "sh-metube", "widget": "", "description": "MeTube 视频下载", "kind": "下载工具", "confidence": "高", "group_hints": ("群晖NAS", "下载", "Downloads")},
    {"needles": ("lsky",), "icon": "sh-lskypro", "widget": "", "description": "Lsky Pro 图床管理", "kind": "图床服务", "confidence": "高", "group_hints": ("群晖NAS", "内网Tools", "图床")},
    ...
    {"needles": ("komari",), "icon": "sh-komari", "widget": "", "description": "Komari 服务器监控", "kind": "服务器监控", "confidence": "高", "group_hints": ("内网Tools", "监控", "Monitoring", "Tools")},
