...
v0.5.2 起默认部署只需要一个 `homepage-admin` 容器：
...
3. 上传解压后的普通项目文件进行覆盖。
4. Commit message：`Release v0.5.2`。
5. 打开 **Actions**。
...
创建 Tag `v0.5.2` 时，会生成类似：

```text
ghcr.io/aspeternity/homepage-admin:0.5.2
